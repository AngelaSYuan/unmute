  ...
  return (
    <div className="container">
            ...
            <div className="videoContainer">
                <img src={Tmp}/>
                <button className="purpleButton" onClick={handleRecordNewVideo}> <img src={Record} alt="Record button"/>Record video</button>
                <button className="purpleButton" onClick={handleDownloadVideo}> <img src={Record} alt="Record button"/>Record video</button>
            </div>
